...
pub use {evm::NexisEVM, solana_sdk::reward_type::RewardType};
...
impl Bank {
    ...
    pub fn simulate_transaction_unchecked(
        ...
        let LoadAndExecuteTransactionsOutput {
            ...
            NexisEVM::context_for_simulation(&self),
        );
    ...
    fn execute_loaded_transaction(
        ...
        if tx.message().is_modify_evm_state() {
            NexisEVM::cleanup(evm_executor_context, &process_result);
        }
    ...
    pub fn load_execute_and_commit_transactions(
        ...
        let LoadAndExecuteTransactionsOutput {
            ...
            timings,
            None,
            NexisEVM::context_for_execution(&self),
        );
