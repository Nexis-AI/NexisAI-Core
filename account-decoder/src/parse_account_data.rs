...
lazy_static! {
    ...
    static ref NEXIS_ACCOUNT_PROGRAM_ID: Pubkey = velas_account_program::id();
    static ref EVM_PROGRAM_ID: Pubkey = evm_state::id();
    static ref NEXIS_RELYING_PARTY_PROGRAM_ID: Pubkey = velas_relying_party_program::id();
...
pub fn parse_account_data(
    ...
    let parsed_json = match program_name {
        ...
        ParsableAccount::NexisAccount => {
            serde_json::to_value(velas_account_program::NexisAccountType::try_from(data)?)?
        }
