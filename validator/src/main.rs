...
fn process_account_indexes(matches: &ArgMatches) -> AccountSecondaryIndexes {
    let account_indexes: HashSet<AccountIndex> = matches
        ...
        .map(|value| match value {
            ...
            "velas-accounts-storages" => AccountIndex::NexisAccountStorage,
            "velas-accounts-owners" => AccountIndex::NexisAccountOwner,
            "velas-accounts-operationals" => AccountIndex::NexisAccountOperational,
            "velas-relying-party-owners" => AccountIndex::NexisRelyingOwner,
