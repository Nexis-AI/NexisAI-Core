...
pub mod chain_id_rpc {
    ...
    pub trait ChainIDERPC {
        ...
        #[rpc(meta, name = "nzt_getStorageAt")]
        fn storage_at(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getTransactionCount")]
        fn transaction_count(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getBlockTransactionCountByHash")]
        fn block_transaction_count_by_hash(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getBlockTransactionCountByNumber")]
        fn block_transaction_count_by_number(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getBlockByHash")]
        fn block_by_hash(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getBlockByNumber")]
        fn block_by_number(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getTransactionByHash")]
        fn transaction_by_hash(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getTransactionByBlockHashAndIndex")]
        fn transaction_by_block_hash_and_index(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getTransactionByBlockNumberAndIndex")]
        fn transaction_by_block_number_and_index(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
        ...
        #[rpc(meta, name = "nzt_getTransactionReceipt")]
        fn transaction_receipt(
            &self,
            meta: Self::Metadata,
            chain: EvmChain,
