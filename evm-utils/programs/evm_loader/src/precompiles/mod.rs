...
pub use {
    abi_parse::*,
    builtins::{ETH_TO_NZT_ADDR, ETH_TO_NZT_CODE},
...
mod test {
    ...
    fn call_to_sha256() {
        ...
        AccountStructure::testing(0, |accounts: AccountStructure| {
            let precompiles = entrypoint(accounts, PrecompileSet::NexisClassic, false, false);
            let input = [0u8; 0];
    ...
    fn call_modexp() {
        ...
        AccountStructure::testing(0, |accounts| {
            let precompiles = entrypoint(accounts, PrecompileSet::NexisNext, false, false);
            let input = hex!(
                "
